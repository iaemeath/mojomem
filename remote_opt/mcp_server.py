...
class MojomemMCP:
    ...
    def _tools_list(self):
        local_tools = [
            ...
            {"name": "mem_delete", "description": "软删除记忆（标 deleted_at）。", "inputSchema": {"type": "object", "properties": {"obs_id": {"type": "string"}}, "required": ["obs_id"]}},
        ...
        try:
            ...
            print(f"[tools/list] CBM unavailable: {e}")
