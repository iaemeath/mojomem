...
struct WordPieceTokenizer:
    ...
    fn encode(self, text: String, max_length: Int = 512) -> List[Int]:
        ...
        # Truncate if necessary (reserve 1 slot for SEP)
...
fn main() raises:
    ...
    var ids = tok.encode("我爱NLP", max_length=10)
    print("Encoded '我爱NLP':")
    for i in range(len(ids)):
        print(ids[i])
        
    var ids2 = tok.encode("This is a test code", max_length=15)
    print("Encoded 'This is a test code':")
